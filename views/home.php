...
<section id="home">
    <div class="p-5 bg-light rounded-3">
        <div class="container-fluid py-5">
            ...
            <a href="#jadwal" class="ms-1 ms-lg-3 btn btn-success" type="button"><i class="fa-solid fa-calendar-days text-light"></i> Lihat Jadwal <i class="fa-solid fa-angles-right"></i></a>
        </div>
    </div>
</section>
