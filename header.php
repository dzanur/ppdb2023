            ...
            <ul class="navbar-nav mx-auto mb-2 mb-md-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-primary-700 shadow-lg px-3">
                        ...
                        <li><a class="dropdown-item nav-link" <?php if ($daftar == "true") { echo "href='" . $linkppdb . $mutasi . "01/daftar'  target='_BLANK'";}else {echo "";}?>><i class="fa-solid fa-right-left"></i> Perpindahan Tugas Orang Tua</a></li>
                        <li><hr></li>
